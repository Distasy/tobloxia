...
export default function ShopCard(props)
{
    ...
    const objImage = "https://www.roblox.com/asset-thumbnail/image?assetId=" + objId + "&width=768&height=432&format=png";
    const width  = vw * 75;
    const height = vw *  70;
    return (
                        ...
                        <Row style={{ height: "50%" }}>
                            <View style={{ alignItems: "center", height: "100%", width: "100%" }}>
                                ...
                                >
                                    ...
                                    <Text style={[styles.title, { color: "white", fontSize: vw * 4 }]}>T shirt bo</Text>
                                </TextTicker>
                            </View>
